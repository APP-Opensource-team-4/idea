...
| 주차 | 주요 활동 내용                                                                 |
|------|------------------------------------------------------------------------------|
| 1주차 | ✅ Figma를 통해 전체 UI 구성 진행 중<br>✅ Android XML 레이아웃 구현 시작<br>🛠️ Firebase Firestore 기반 데이터베이스 구조 설계 중<br>🧩 기능별 개발 항목 정리 및 리드미 작성 완료<br>📄 프로젝트 README 및 개발 가이드 작성<br>📁 GitHub 폴더 및 이미지 구조 세팅 완료 |
